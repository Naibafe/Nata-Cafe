export const data = [
  ...
  },
  {
    id: 2,
    name: "Cappuccino",
    description: "Kawa z mleczną pianką, idealna na leniwe poranki.",
    price: 12.99,
    image:
  ...
  },
  {
    ...
    description: "Delikatna kawa z mlekiem podawana w wysokiej szklance.",
    price: 13.99,
    image:
  ...
  },
  {
    ...
    description: "Czekoladowe ciastko z chrupiącą skórką i miękkim środkiem.",
    price: 8.49,
    image:
  ...
  },
  {
    ...
    description: "Puszysty sernik na spodzie z herbatników.",
    price: 11.99,
    image:
  ...
  },
  {
    id: 7,
    name: "Tarta owocowa",
    description: "Kruche ciasto z budyniem i świeżymi owocami sezonowymi.",
    price: 12.49,
    image:
  ...
  {
    id: 8,
    name: "Croissant z migdałami",
    description:
      "Francuskie ciasto z nadzieniem migdałowym, posypane cukrem pudrem.",
    price: 7.99,
    image:
  ...
  },
  {
    ...
    name: "Mocha",
    description:
      "Połączenie espresso, czekolady i mleka – dla miłośników słodyczy.",
    price: 13.49,
    image:
